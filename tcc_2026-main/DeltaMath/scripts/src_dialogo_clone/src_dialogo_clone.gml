function src_dialogo_clone(_text_id){
	...
	switch(_text_id){
		case"clone": //fala do clone quando o jogador interage com ele
		...
		case "clone_sim"://jogador concorda com o clone
		...
		case "clone_???":
			src_text("Tô falando isso porque o programador daqui NÂO SE DEU O TRABALHO DE SIMPLESMENTE COLOCAR OUTRA IMAGEM QUE NÂO SEJA O SANS!!!!!!!!!!", "sans");
			global.sans = true;
			break;
